...
- Indexed station search/spatial queries, throttled API access, bounded station caching, active-tab polling, Low Data/Low Power/thermal-aware cadence and continuous animations, and stale offline fallback.
