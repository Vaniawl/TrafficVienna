...
- Device-local email authentication with repeated-attempt cooldown and native Sign in with Apple.
...
- Departure reminders, Live Activities, Dynamic Island, and a home-screen widget with deduplicated app-driven timeline updates.
- Indexed station search/spatial queries, throttled API access, bounded and memory-pressure-aware response caching, active-tab polling, Low Data/Low Power/thermal-aware cadence and continuous animations, and stale offline fallback.
