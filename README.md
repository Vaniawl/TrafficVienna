...
- Indexed station search/spatial queries, throttled API access, active-tab polling, Low Data/Low Power-aware cadence, energy-aware continuous animations, and stale offline fallback.
