...
- Indexed station search/spatial queries, throttled API access, active-tab polling, Low Data/Low Power/thermal-aware cadence and continuous animations, and stale offline fallback.
