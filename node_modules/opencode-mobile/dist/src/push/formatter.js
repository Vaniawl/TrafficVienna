...
function extractSessionTitle(properties) {
...
export function formatNotification(event, serverUrl, ctx) {
    ...
    switch (type) {
        case "session.idle": {
            ...
            debugLog("[PushPlugin] Last assistant message:", lastAssistantMessage
        ...
        case "session.error":
            return {
                title: "Session Error",
                body: truncate(String(properties?.error || properties?.message || "An error occurred"), 100),
                data: baseData,
            };
        case "permission.updated":
            return {
