 ...
 */
import { removePluginFromGlobalOpenCodeConfig, removeGlobalCommand, } from "./opencode-config.js";
...
async function askConfirmation() {
    ...
    return new Promise((resolve) => {
        rl.question('⚠️  Are you sure you want to uninstall opencode-mobile? This will remove:\n' +
        ...
        try {
            ...
            if (parsed && typeof parsed === "object" && !Array.isArray(parsed)) {
                ...
                if (Array.isArray(plugins)) {
                    pluginInstalled = plugins.some((p) => typeof p === "string" && (p === PLUGIN_SPEC || p.startsWith(`${PLUGIN_SPEC}@`)));
                }
            }
        }
        catch {
