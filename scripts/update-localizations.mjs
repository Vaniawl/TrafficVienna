...
const newEnglish = [
  ...
  "Saved data", "Saved data, %@", "Saved stations", "See all", "Service is busy right now. Please try again in a moment.", "Showing saved data", "Show password", "We’ll notify you shortly before %@ departs.",
