...
const newEnglish = [
  "%@ leaves soon", "%@ → %@ in about %lld min.", "Account", "Active days", "Add a favourite station first, then create a daily routine.", "Add a favourite station first, then create a routine.", "Add routine", "Cancel", "Cancel all", "Cancel all reminders", "Cancel all reminders?", "Couldn’t start Lock Screen tracking. Please try again.", "Departure reminder", "Departure reminders", "Display name", "Edit", "Edit display name", "Edit routine", "Every day", "Keep reminders", "Live Activities are turned off. Enable them in Settings to track departures on your Lock Screen.", "Lock Screen tracking", "No departure reminders", "Not selected", "Save", "Select at least one day", "Selected", "Set a reminder from any live departure to see it here.", "Tracking %@ on your Lock Screen.", "Updated %@ on your Lock Screen.", "Weekdays", "Weekends",
  ...
  "Remind", "Saved data", "Saved data, %@", "Saved stations", "See all", "Service is busy right now. Please try again in a moment.", "Showing saved data", "Show password", "Track", "We’ll notify you shortly before %@ departs.",
...
const de = {
  ...
  "Saved data":"Gespeicherte Daten", "Saved data, %@":"Gespeicherte Daten, %@", "Saved stations":"Gespeicherte Stationen", "See all":"Alle anzeigen", "Service is busy right now. Please try again in a moment.":"Der Dienst ist gerade ausgelastet. Versuche es gleich noch einmal.", "Showing saved data":"Gespeicherte Daten werden angezeigt",
...
const uk = {
  ...
  "Saved data":"Збережені дані", "Saved data, %@":"Збережені дані, %@", "Saved stations":"Збережені станції", "See all":"Переглянути всі", "Service is busy right now. Please try again in a moment.":"Сервіс зараз перевантажений. Спробуйте ще раз за мить.", "Showing saved data":"Показано збережені дані",
