...
const newEnglish = [
  ...
  "Face ID", "Touch ID", "Optic ID", "Biometric unlock", "Device passcode", "Biometric authentication is not available on this device.", "Couldn’t verify your identity. Please try again.", "Confirm to enable biometric unlock.", "Unlock Traffic Vienna.", "Traffic Vienna is locked", "Unlock to see your departures and saved travel data.", "Unlock with %@", "Security", "Use %@", "Require biometric authentication when returning to the app.", "Biometrics changed. You can unlock with your device passcode or turn off app lock.", "Biometric app lock", "Face ID, Touch ID, or Optic ID is verified by the system. Traffic Vienna never receives or stores your biometric data.", "Immediately", "After 1 minute", "After 5 minutes", "Require unlock", "Private information is always hidden while the app is inactive. Choose when identity verification is required after returning.",
  ...
  "Privacy & data", "Your account", "Identity", "Email password verifiers stay in Keychain on this device. Sign in with Apple uses Apple’s system authentication service. Traffic Vienna has no account server.", "Email accounts and preferences do not sync between devices.", "Location", "Used only when needed", "Location access is optional and helps find nearby stops. Traffic Vienna does not save your coordinates or send them with transit requests.", "On this device", "Travel preferences", "Favourites, recent searches, routines, appearance, and widget state are stored locally in the app or its shared widget container.", "Export my data", "Couldn’t export data", "The export includes your profile details and saved travel preferences. It never includes passwords, authentication tokens, live-data caches, or your location history.", "Network requests", "Wiener Linien live data", "Traffic Vienna requests departures and service alerts over HTTPS using public stop identifiers. Wiener Linien can observe the request’s source IP address.", "No advertising or tracking", "Traffic Vienna contains no ads, analytics, or tracking SDKs.",
...
const de = {
  "Restore from backup":"Aus Backup wiederherstellen", "Restore this backup?":"Dieses Backup wiederherstellen?", "Replace local data":"Lokale Daten ersetzen", "Backup restored":"Backup wiederhergestellt", "Your account and App Lock were not changed.":"Dein Konto und die App-Sperre wurden nicht geändert.", "Couldn’t complete the data operation":"Datenvorgang konnte nicht abgeschlossen werden", "The backup file is too large.":"Die Backup-Datei ist zu groß.", "This isn’t a valid Traffic Vienna backup.":"Dies ist kein gültiges Traffic-Vienna-Backup.", "This backup version isn’t supported.":"Diese Backup-Version wird nicht unterstützt.", "The backup couldn’t be restored. Your previous data was kept.":"Das Backup konnte nicht wiederhergestellt werden. Deine bisherigen Daten wurden beibehalten.", "The backup couldn’t be restored completely. Review your local data before trying again.":"Das Backup konnte nicht vollständig wiederhergestellt werden. Prüfe deine lokalen Daten, bevor du es erneut versuchst.", "Backup contains %lld stations, %lld routes, %lld routines, and %lld recent searches. Existing travel data, appearance, and Home layout will be replaced. Your account and App Lock stay unchanged.":"Das Backup enthält %lld Stationen, %lld Verbindungen, %lld Routinen und %lld letzte Suchanfragen. Vorhandene Reisedaten, Erscheinungsbild und Startseitenlayout werden ersetzt. Dein Konto und die App-Sperre bleiben unverändert.",
  "Face ID":"Face ID", "Touch ID":"Touch ID", "Optic ID":"Optic ID", "Biometric unlock":"Biometrische Entsperrung", "Device passcode":"Gerätecode", "Biometric authentication is not available on this device.":"Biometrische Authentifizierung ist auf diesem Gerät nicht verfügbar.", "Couldn’t verify your identity. Please try again.":"Deine Identität konnte nicht bestätigt werden. Versuche es erneut.", "Confirm to enable biometric unlock.":"Bestätige, um die biometrische Entsperrung zu aktivieren.", "Unlock Traffic Vienna.":"Traffic Vienna entsperren.", "Traffic Vienna is locked":"Traffic Vienna ist gesperrt", "Unlock to see your departures and saved travel data.":"Entsperre die App, um deine Abfahrten und gespeicherten Reisedaten zu sehen.", "Unlock with %@":"Mit %@ entsperren", "Security":"Sicherheit", "Use %@":"%@ verwenden", "Require biometric authentication when returning to the app.":"Beim Zurückkehren zur App eine biometrische Authentifizierung verlangen.", "Biometrics changed. You can unlock with your device passcode or turn off app lock.":"Die Biometrie wurde geändert. Du kannst mit dem Gerätecode entsperren oder die App-Sperre ausschalten.", "Biometric app lock":"Biometrische App-Sperre", "Face ID, Touch ID, or Optic ID is verified by the system. Traffic Vienna never receives or stores your biometric data.":"Face ID, Touch ID oder Optic ID wird vom System geprüft. Traffic Vienna empfängt oder speichert niemals deine biometrischen Daten.", "Immediately":"Sofort", "After 1 minute":"Nach 1 Minute", "After 5 minutes":"Nach 5 Minuten", "Require unlock":"Entsperrung verlangen", "Private information is always hidden while the app is inactive. Choose when identity verification is required after returning.":"Private Informationen werden immer ausgeblendet, wenn die App inaktiv ist. Wähle, wann nach der Rückkehr eine Identitätsprüfung erforderlich ist.",
...
const uk = {
  "Restore from backup":"Відновити з резервної копії", "Restore this backup?":"Відновити цю резервну копію?", "Replace local data":"Замінити локальні дані", "Backup restored":"Резервну копію відновлено", "Your account and App Lock were not changed.":"Ваш акаунт і блокування застосунку не змінено.", "Couldn’t complete the data operation":"Не вдалося завершити операцію з даними", "The backup file is too large.":"Файл резервної копії завеликий.", "This isn’t a valid Traffic Vienna backup.":"Це не є дійсною резервною копією Traffic Vienna.", "This backup version isn’t supported.":"Ця версія резервної копії не підтримується.", "The backup couldn’t be restored. Your previous data was kept.":"Не вдалося відновити резервну копію. Попередні дані збережено.", "The backup couldn’t be restored completely. Review your local data before trying again.":"Не вдалося повністю відновити резервну копію. Перевірте локальні дані перед повторною спробою.", "Backup contains %lld stations, %lld routes, %lld routines, and %lld recent searches. Existing travel data, appearance, and Home layout will be replaced. Your account and App Lock stay unchanged.":"Резервна копія містить %lld станцій, %lld маршрутів, %lld сценаріїв і %lld недавніх пошуків. Наявні дані поїздок, вигляд і компонування головного екрана буде замінено. Ваш акаунт і блокування застосунку залишаться без змін.",
  "Face ID":"Face ID", "Touch ID":"Touch ID", "Optic ID":"Optic ID", "Biometric unlock":"Біометричне розблокування", "Device passcode":"Код пристрою", "Biometric authentication is not available on this device.":"Біометрична автентифікація недоступна на цьому пристрої.", "Couldn’t verify your identity. Please try again.":"Не вдалося підтвердити вашу особу. Спробуйте ще раз.", "Confirm to enable biometric unlock.":"Підтвердьте ввімкнення біометричного розблокування.", "Unlock Traffic Vienna.":"Розблокуйте Traffic Vienna.", "Traffic Vienna is locked":"Traffic Vienna заблоковано", "Unlock to see your departures and saved travel data.":"Розблокуйте застосунок, щоб побачити відправлення та збережені дані поїздок.", "Unlock with %@":"Розблокувати за допомогою %@", "Security":"Безпека", "Use %@":"Використовувати %@", "Require biometric authentication when returning to the app.":"Вимагати біометричну автентифікацію після повернення до застосунку.", "Biometrics changed. You can unlock with your device passcode or turn off app lock.":"Біометричні дані змінилися. Можна розблокувати застосунок кодом пристрою або вимкнути блокування.", "Biometric app lock":"Біометричне блокування застосунку", "Face ID, Touch ID, or Optic ID is verified by the system. Traffic Vienna never receives or stores your biometric data.":"Face ID, Touch ID або Optic ID перевіряє система. Traffic Vienna ніколи не отримує та не зберігає ваші біометричні дані.", "Immediately":"Негайно", "After 1 minute":"Через 1 хвилину", "After 5 minutes":"Через 5 хвилин", "Require unlock":"Вимагати розблокування", "Private information is always hidden while the app is inactive. Choose when identity verification is required after returning.":"Приватна інформація завжди приховується, коли застосунок неактивний. Виберіть, коли після повернення потрібно підтвердити особу.",
  ...
  "Privacy & data":"Приватність і дані", "Your account":"Ваш акаунт", "Identity":"Ідентифікація", "Email password verifiers stay in Keychain on this device. Sign in with Apple uses Apple’s system authentication service. Traffic Vienna has no account server.":"Засіб перевірки пароля електронної пошти зберігається у Keychain на цьому пристрої. Вхід з Apple використовує системну службу автентифікації Apple. Traffic Vienna не має сервера акаунтів.", "Email accounts and preferences do not sync between devices.":"Акаунти електронної пошти й налаштування не синхронізуються між пристроями.", "Location":"Геолокація", "Used only when needed":"Використовується лише за потреби", "Location access is optional and helps find nearby stops. Traffic Vienna does not save your coordinates or send them with transit requests.":"Доступ до геолокації необов’язковий і допомагає знаходити зупинки поруч. Traffic Vienna не зберігає ваші координати й не надсилає їх у запитах до транспортного сервісу.", "On this device":"На цьому пристрої", "Travel preferences":"Налаштування поїздок", "Favourites, recent searches, routines, appearance, and widget state are stored locally in the app or its shared widget container.":"Обране, недавні пошуки, сценарії, вигляд і стан віджета зберігаються локально в застосунку або спільному контейнері віджета.", "Export my data":"Експортувати мої дані", "Couldn’t export data":"Не вдалося експортувати дані", "The export includes your profile details and saved travel preferences. It never includes passwords, authentication tokens, live-data caches, or your location history.":"Експорт містить дані профілю та збережені налаштування поїздок. Він ніколи не містить паролів, токенів автентифікації, кешу актуальних даних або історії геолокації.", "Network requests":"Мережеві запити", "Wiener Linien live data":"Актуальні дані Wiener Linien", "Traffic Vienna requests departures and service alerts over HTTPS using public stop identifiers. Wiener Linien can observe the request’s source IP address.":"Traffic Vienna запитує відправлення та зміни руху через HTTPS, використовуючи публічні ідентифікатори зупинок. Wiener Linien може бачити IP-адресу джерела запиту.", "No advertising or tracking":"Без реклами та відстеження", "Traffic Vienna contains no ads, analytics, or tracking SDKs.":"Traffic Vienna не містить реклами, аналітики чи SDK для відстеження.",
