...
const newEnglish = [
  "Favourites only", "Show all stops", "Stops list", "Visible stops", "Closest first", "No favourite stops in view", "No stops in view", "Move the map or show all stops.",
  "Stops in view: %lld",
...
const de = {
  "Favourites only":"Nur Favoriten", "Show all stops":"Alle Haltestellen anzeigen", "Stops list":"Haltestellenliste", "Visible stops":"Sichtbare Haltestellen", "Closest first":"Nächste zuerst", "No favourite stops in view":"Keine Favoriten im Ausschnitt", "No stops in view":"Keine Haltestellen im Ausschnitt", "Move the map or show all stops.":"Verschiebe die Karte oder zeige alle Haltestellen an.",
...
const uk = {
  "Favourites only":"Лише обране", "Show all stops":"Показати всі зупинки", "Stops list":"Список зупинок", "Visible stops":"Видимі зупинки", "Closest first":"Найближчі спочатку", "No favourite stops in view":"На мапі немає обраних зупинок", "No stops in view":"На мапі немає зупинок", "Move the map or show all stops.":"Перемістіть мапу або покажіть усі зупинки.",
