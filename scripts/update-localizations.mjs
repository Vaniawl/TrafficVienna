...
const newEnglish = [
  "%@ leaves soon", "%@ → %@ in about %lld min.", "Account", "Add a favourite station first, then create a daily routine.", "Add routine", "Cancel", "Display name", "Edit", "Edit display name", "Edit routine", "Save",
  ...
  "Enable notifications in Settings to receive departure reminders.", "No connection. Check your internet and try again.", "No connection. Showing the most recently saved data.", "Password", "Real-time departures and service updates", "Refresh", "Remind me before departure", "Routines", "This departure is too soon for a reminder.",
  "Saved data", "Saved data, %@", "Service is busy right now. Please try again in a moment.", "Showing saved data", "Show password", "We’ll notify you shortly before %@ departs.",
