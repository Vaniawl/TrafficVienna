...
const newEnglish = [
  "Hidden modules keep their data and can be shown again at any time.", "Home modules", "Home screen", "Live departures for your favourite lines", "Quick access to your favourite stops", "Relevant alerts, routines, and updates", "Restore default layout", "Smart insight",
...
const de = {
  "Hidden modules keep their data and can be shown again at any time.":"Ausgeblendete Module behalten ihre Daten und können jederzeit wieder angezeigt werden.", "Home modules":"Startseitenmodule", "Home screen":"Startseite", "Live departures for your favourite lines":"Live-Abfahrten deiner Lieblingslinien", "Quick access to your favourite stops":"Schnellzugriff auf deine Lieblingshaltestellen", "Relevant alerts, routines, and updates":"Relevante Meldungen, Routinen und Aktualisierungen", "Restore default layout":"Standardlayout wiederherstellen", "Smart insight":"Smarte Übersicht",
