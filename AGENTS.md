...
- Run tests: `bash scripts/test.sh` (automatically selects an exact available
  `iPhone 17` UUID; override with `TRAFFICVIENNA_SIMULATOR_ID` or
  `TRAFFICVIENNA_XCODE_DESTINATION`)
